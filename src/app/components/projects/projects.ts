  ...
  projects = [
    {
      ...
      shortDescription:
        'A full-stack operations dashboard built for structured workflows, task visibility, and internal data management.',
      hoverDescription:
        'An admin-focused platform designed to support day-to-day operations, workflow control, and secure business processes.',
    ...
    },
    {
      ...
      shortDescription:
        'A membership-focused web application with internal features, administrative tools, and secure access.',
      hoverDescription:
    ...
    },
    {
      ...
      hoverDescription:
        'A service-focused website with strong visual presentation, responsive layout, and lead-oriented design.',
    ...
    },
    {
      ...
      hoverDescription:
        'A business presentation website with polished layout, clear structure, and modern visual design.',
    ...
    },
    {
      ...
      shortDescription:
        'A multi-role web platform designed for structured voting workflows, user actions, and administrative control.',
      hoverDescription:
        'A custom role-based system with permission-aware features, admin tools, and interactive platform workflows.',
    ...
    },
    {
      ...
      shortDescription:
        'A community-focused web application with user registration, login, messaging, replies, reactions, and image sharing.',
      hoverDescription:
        'A full-stack social-style platform built around structured user interaction, account management, and secure role-based access.',
